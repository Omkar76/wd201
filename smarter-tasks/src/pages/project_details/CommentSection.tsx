...
export function CommentSection (){
    ...
    return (
        <>
        <form className="flex flex-col my-2 gap-2" onSubmit={
            (e)=>{
              e.preventDefault();
            ...
            <input className="flex-1 p-2  outline-transparent border-2" value={commentText} onChange={(e)=>{
              setCommentText(e.target.value)
            }}/>
            <button id="addCommentButton" className="ml-auto bg-blue-600 text-white p-2 rounded-md">
                  Post Comment
            </button>
          </form>
