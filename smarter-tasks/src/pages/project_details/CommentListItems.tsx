  ...
  return (
    <>
      {comments.map((comment: any) => (
        <div
          key={comment.id}
          className="comment p-2 bg-white border border-gray-200 rounded-sm shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
        >
          <div className="">
